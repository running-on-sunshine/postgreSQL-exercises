...
-------------------------------------------------------------------
-- How can you retrieve all the information from the             --
-- cd.facilities table?                                          --
-------------------------------------------------------------------
...
-------------------------------------------------------------------
-- How can you retrieve the details of facilities with ID 1 and  --
-- 5?                                                            --
--                                                               --
...
--                                                               --
-- Return the name and monthly maintenance of the facilities in  --
--  question.                                                    --
-------------------------------------------------------------------
...
-- start of September 2012?                                      --
--                                                               --
-- Return the memid, surname, firstname, and joindate of the     --
-- members in question.                                          --
-------------------------------------------------------------------
...
-------------------------------------------------------------------
-- You, for some reason, want a combined list of all surnames    --
-- and all facility names. Yes, this is a contrived example :-). --
--                                                               --
-- Produce that list!                                            --
-------------------------------------------------------------------
...
-------------------------------------------------------------------
-- You'd like to get the first and last name of the last         --
-- member(s) who signed up - not just the date.                  --
--                                                               --
-- How can you do that?                                          --
-------------------------------------------------------------------
